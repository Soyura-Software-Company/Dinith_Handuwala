...
LOCK TABLES `zoomlink` WRITE;
/*!40000 ALTER TABLE `zoomlink` DISABLE KEYS */;
INSERT INTO `zoomlink` VALUES (1,'czxzsvvszv',1),(2,'bfhbxbdb',1);
/*!40000 ALTER TABLE `zoomlink` ENABLE KEYS */;
UNLOCK TABLES;
